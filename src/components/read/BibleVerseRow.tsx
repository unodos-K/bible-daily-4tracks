...
export default function BibleVerseRow({ trackType, book, chapter, verse, fontSize, dayIndex, selectedVerse, confirmedVerse, record, onVerseClick, onConfirmVerse, onOpenMemory, onShare }: BibleVerseRowProps) {
