...
export default function BibleVerseRow({ trackType, book, chapter, verse, fontSize, dayIndex, selectedVerse, confirmedVerse, candidates, record, onVerseClick, onConfirmVerse, onToggleCandidate, onOpenMemory, onShare }: BibleVerseRowProps) {
