    ...
    <div className="fixed right-0 top-1/2 -translate-y-1/2 z-40 ios-pwa-bottom-safe mr-1 md:mr-2 pointer-events-auto select-none touch-manipulation">
      <div className="flex flex-col gap-1 md:gap-1.5 p-1 md:p-2 bg-zinc-900/80 backdrop-blur-md rounded-[2rem] shadow-lg">
        {items.map(([id, icon, label]) => (
          <button key={id} onClick={() => onNavigate(id)} className="flex flex-col items-center justify-center w-[38px] h-[38px] md:w-16 md:h-16 aspect-square rounded-full bg-stone-800/80 hover:bg-stone-700 active:scale-95 text-stone-300 border border-stone-700/50 shadow-md transition-all hover:scale-105 gap-0 md:gap-1 cursor-pointer" title={label}>
        ...
        <button onClick={onOneVerse} className="flex flex-col items-center justify-center w-[38px] h-[38px] md:w-16 md:h-16 aspect-square rounded-full bg-stone-800/80 hover:bg-stone-700 active:scale-95 text-stone-300 border border-stone-700/50 shadow-md transition-all hover:scale-105 gap-0 md:gap-1 cursor-pointer" title="One">
        ...
        <button onClick={() => onNavigate("viewer-bottom")} className="flex flex-col items-center justify-center w-[38px] h-[38px] md:w-16 md:h-16 aspect-square rounded-full bg-stone-800/80 hover:bg-stone-700 active:scale-95 text-stone-300 border border-stone-700/50 shadow-md transition-all hover:scale-105 gap-0 md:gap-1 cursor-pointer" title="완료">
