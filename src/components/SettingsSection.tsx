...
import { Moon, Sun, Monitor, Type, Minus, Plus } from "lucide-react";
...
export default function SettingsSection() {
  ...
  return (
    <div className="bg-white dark:bg-stone-900 rounded-3xl p-6 shadow-sm border border-stone-200/50 dark:border-stone-800 flex flex-col gap-8">
      <h3 className="text-xl font-bold text-stone-800 dark:text-stone-100 mb-2">환경 설정</h3>
