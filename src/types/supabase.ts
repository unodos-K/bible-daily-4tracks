  ...
  public: {
    Tables: {
      ...
      one_verse_likes: {
        ...
        Relationships: [
          {
            foreignKeyName: "fk_one_verse_likes_author"
            columns: ["author_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "fk_one_verse_likes_liker"
            columns: ["liker_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      reading_records: {
        ...
        Relationships: [
          {
            foreignKeyName: "fk_reading_records_user"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      reading_settings: {
        ...
        Relationships: [
          {
            foreignKeyName: "fk_reading_settings_user"
            columns: ["user_id"]
            isOneToOne: true
            referencedRelation: "profiles"
            referencedColumns: ["id"]
